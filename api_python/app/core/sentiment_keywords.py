...
ASPECT_KEYWORDS: Dict[str, list] = {
    ...
    "design": ["wygląd", "design", "obudowa", "jakość wykonania", "leży w dłoni", "wzornictwo", "wykonanie"],
    "oprogramowanie": ["system", "soft", "software", "android", "ios", "nakładka", "aktualizacje"],
    "cena": ["cena", "cenę", "pieniądze", "kosztuje", "drogi", "tani"],
}
